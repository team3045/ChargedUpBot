...
// The robot's subsystems
    ...
    public final int _9=5; public final int _10=4; public final int _11=3;
...
// Joysticks
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(buttonboard, _9).whileTrue(balance);

    new JoystickButton(buttonboard, _10).whileTrue(intakeCone);

    new JoystickButton(buttonboard, _11).whileTrue(outtake);
