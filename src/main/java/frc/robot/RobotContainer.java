...
// The robot's subsystems
    ...
    public final FBUP fbUP; 
    public final FBDown fbDown;

    public final AutonomousFourBarLow fblow;
...
// Joysticks
  ...
  private RobotContainer() {
    ...
    fbUP = new FBUP(m_fourBar);
    fbDown = new FBDown(m_fourBar);
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(buttonboard, 10).whileTrue(fourBar_MidPos);

    new JoystickButton(buttonboard, Constants.highPosID).whileTrue(fourBar_HighPos);

    new JoystickButton(buttonboard, 12).whileTrue(fourBar_LowPos);

   new JoystickButton(buttonboard, 8).whileTrue(fbDown);
   // new JoystickButton(buttonboard, 10).onTrue(fbmid);
    new JoystickButton(buttonboard, 7).whileTrue(fbUP);
...
public XboxController getController() {
  ...
  private Command[] getCommandsFromStrings(String... strings) throws Exception {
