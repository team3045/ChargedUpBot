...
public class RobotContainer {
  ...
  public final XboxController drive_controller = new XboxController(1);
  ...
  private RobotContainer() {
    ...
    m_driveTrain.setDefaultCommand(new Teleop_Drive(m_driveTrain, this));
  ...
  private void configureButtonBindings() {
    ...
    low.toggleOnTrue(
        new GoToPosition_TelescopingArm(m_telescopingArm).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
