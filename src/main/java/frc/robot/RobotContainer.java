...
// Joysticks
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(buttonboard, Constants.midPosID).whileTrue(fourBar_MidPos);

    new JoystickButton(buttonboard, Constants.highPosID).whileTrue(fourBar_HighPos);

    new JoystickButton(buttonboard, 9).onTrue(fbhigh);
    new JoystickButton(buttonboard, 10).onTrue(fbmid);
    new JoystickButton(buttonboard, 12).onTrue(fblow);
