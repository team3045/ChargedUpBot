  ...
  public enum DriveMode {
    ...
    */
    public DriveTrain() {
        ...
        leftMotor1 = new WPI_TalonFX(Constants.lMotor1);
        leftMotor2 = new WPI_TalonFX(Constants.lMotor2);
        leftMotor3 = new WPI_TalonFX(Constants.lMotor3);
        rightMotor1 = new WPI_TalonFX(Constants.rMotor1);
        rightMotor2 = new WPI_TalonFX(Constants.rMotor2);
        rightMotor3 = new WPI_TalonFX(Constants.rMotor3);

        gyro = new Pigeon2(Constants.gyro);
