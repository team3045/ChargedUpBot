...
NetworkTable pedalTable;
public BooleanSubscriber pedalDown;
  ...
  public enum DriveMode {
    ...
    */
    public DriveTrain() {
      ...
      pigeonGyro = new PigeonGyro(pigeon);
      ...
      pedalTable = NetworkTableInstance.getDefault().getTable("pedalTable");
      pedalDown = pedalTable.getBooleanTopic("pedal").subscribe(false, new PubSubOption[0]);
    ...
    public double getLeftWheelPosition() {
      return -leftMotor1.getSelectedSensorPosition() / 2048 / 10.5 * 0.1523;
    }
    
    public double getRightWheelPosition() {
      return -rightMotor1.getSelectedSensorPosition() / 2048 / 10.5 * 0.1523;
    }
    ...
    public void periodic() {
        ...
        SmartDashboard.putData("gyro", pigeonGyro);
    ...
    public void tankDrive(double leftpower, double rightpower) {
        ...
        //m_drive.feed();
        boolean doubSpeed = RobotContainer.m_robotContainer.LJoystick.getRawButton(1) || RobotContainer.m_robotContainer.RJoystick.getRawButton(1) || pedalDown.get();
        SmartDashboard.putBoolean("pedal", pedalDown.get());
